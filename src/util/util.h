...
#define T_MENU_DURCHBLICK               T_("Menu.Durchblick")
#define T_MENU_NEW_WINDOW               T_("Menu.NewWindow")
#define T_MENU_MANAGE                   T_("Menu.Manage")
#define T_DIALOG_NEW_MULTIVIEW          T_("Dialog.NewMultiview.Title")
#define T_LABEL_WINDOW_NAME             T_("Dialog.NewMultiview.Name")
#define T_LABEL_PERSISTENT              T_("Dialog.NewMultiview.Persistent")
#define T_DIALOG_MANAGE_MULTIVIEWS      T_("Dialog.ManageMultiviews.Title")
#define T_BUTTON_SHOW                   T_("Dialog.ManageMultiviews.Show")
#define T_BUTTON_RENAME                 T_("Dialog.ManageMultiviews.Rename")
#define T_BUTTON_DELETE                 T_("Dialog.ManageMultiviews.Delete")
#define T_BUTTON_DUPLICATE              T_("Dialog.ManageMultiviews.Duplicate")
